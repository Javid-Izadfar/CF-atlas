  ...
  <div>
    <JayRow class="no-wrap align-center">
      <header class="title">
        ...
        <p>
          Atlas is a website that lists every country with their flags and facts. You can explore
          the world map, search by name or region, and filter by criteria. Learn about the world and
          its diversity with Atlas!
        </p>
      </header>
      <div class="filters">
